...
function EditForm() {
    ...
    useEffect(() => {
        console.log("Fetching:", `http://127.0.0.1:5555/sellers/${username}/${product_id}`);

        fetch(`http://127.0.0.1:5555/sellers/${username}/${product_id}`)
            .then(res => {
                if (!res.ok) {
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                {formik.values.image && (
                    <div>
                        <h4>Image Preview</h4>
                        <img
                            src={`http://127.0.0.1:5555${formik.values.image}`}
                            alt="Product Preview"
